...
ROLE_TABS = {
    'admin':   None,
    'deputy':  ['لوحة المراقبة','روابط الفصول','السجلات','إدارة الغياب',
                'سجل التأخر','الأعذار','التقارير / الطباعة','إرسال رسائل الغياب',
                'جدولة الروابط','المراقبة الحية','إدارة الطلاب','إضافة طالب',
                'إدارة الواتساب','استلام تحويلات', 'التعاميم والنشرات', 'الطلاب المستثنون'],
    'staff':   ['لوحة المراقبة','السجلات','إدارة الغياب','الأعذار','التقارير / الطباعة',
                'المراقبة الحية','إدارة الطلاب','إضافة طالب','التعاميم والنشرات', 'الطلاب المستثنون'],
